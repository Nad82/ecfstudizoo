...
import ServicesformDE from "@/components/formsbe/servicesforms/servicesformDE"
...
export default async function DeleteServicesEPage({params}: Readonly<{params:{id: number}}>){
    
        return(
            <div className="flex min-h-screen w-full flex-col bg-muted/40">
                <main className="grid flex-1 items-center gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
                    <Card x-chunk="employeServices_delete" className="bg-green-800">
                        <CardHeader>
                            <CardTitle className="text-4xl text-yellow-400 text-center">Supprimer le service {params.id}</CardTitle>
                            <br />
                            <br />
                            <CardDescription className="text-lg text-white">
                                L'espace employe vous permet de supprimer le service sous l'identifiant {params.id}.
                            </CardDescription>
                        </CardHeader>
                        <br />
                        <br />
